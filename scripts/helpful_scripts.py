from brownie import accounts, network, config, Contract, AdvancedCollectible, SimpleCollectible
from web3 import Web3
from brownie import interface

LOCAL_BLOCKCHAIN_ENVIRONMENTS = ["hardhat", "development", "ganache", "mainnet-fork"]
OPENSEA_URL = "https://testnets.opensea.io/assets/{}/{}"
BREED_MAPPING = {0: "NORMAL", 1: "FREE_BOTTLE", 2: "BACKSTAGE"}
...
contract_to_mock = {"link_token": AdvancedCollectible, "vrf_coordinator": SimpleCollectible}

########################
##I've cut the part below related to mocks (issues with compiler)
...
def fund_with_link(
    ...
    link_token = Contract.from_abi("link_token", config["networks"][network.show_active()]["link_token"], link_abi )
